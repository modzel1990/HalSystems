...
namespace App\Http\Controllers\HalSystems;
...
class ResourceController extends Controller
{
  ...
  public function Less(){
        ...
        $css = app('App\Http\Controllers\HalSystems\ResourceController')->minify_css($parser->getCss());
        ...
        $compiled = app('App\Http\Controllers\HalSystems\ResourceController')->minify_css($compiled);
